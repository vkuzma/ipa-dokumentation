...
\begin{document}
    ...
    \part{Umfeld und Ablauf}
         \chapter{Aufgabenstellung}
             \input{./kapitel/01_aufgabenstellung.tex}
         \chapter{Tagesjournal}
            \input{./reflexion/reflexion_30_4_12.tex}
            \input{./reflexion/reflexion_2_5_12.tex}
            \input{./reflexion/reflexion_3_5_12.tex}
            \input{./reflexion/reflexion_4_5_12.tex}
            \input{./reflexion/reflexion_8_5_12.tex}
        \chapter{Einleitung}
            \input{./kapitel/02_einleitung.tex}
    \part{Projekt}
         \chapter{Analyse}
            \input{./kapitel/04_analyse.tex}
        \chapter{Terminplanung}
            \input{./kapitel/03_terminplanung.tex}
        \chapter{Funktionsumfang}
            \input{./kapitel/05_projektplanung.tex}
        \chapter{Implementierung}
            \input{./kapitel/06_implementierung.tex}
        \chapter{Testen}
            \input{./kapitel/07_testen.tex}
